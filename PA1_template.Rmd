...
In this study the mean number of steps taken in a day was `r StepsDayMean`.  While `r StepsDaymedian` is the median.

### 4. Time series plot of the average number of steps taken
```{r average steps chart, include=TRUE}
...
```{r Histogram with approximate missing data, include=TRUE}
...
that field 
```{r compare weekday vs weekends, include=TRUE}
